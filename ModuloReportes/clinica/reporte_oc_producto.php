...
$this->SetTextColor('121','105','24');	
$this->Text(80,55,'Orden de Compra por Producto:',1,'C', 0); 
...
$consulta = mysql_query("SELECT * from ORDENDECOMPRA where IDPRODUCTO = '$param1' and FECHA BETWEEN '$fecha1' AND '$fecha2'");
...
$pdf->Output('ReporteOrdeCompraProducto.pdf', 'I');
