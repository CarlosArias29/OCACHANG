...
function Header()
{
	...
	$this->SetTextColor('121','105','24');	
	$this->Text(80,55,'Orden de Compra por Proveedor:',1,'C', 0); 
	$this->Ln(60);
...
$consulta = mysql_query("SELECT * from ORDENDECOMPRA where IDPROVEEDOR = '$param1' and FECHA BETWEEN '$fecha1' AND '$fecha2'");
...
$pdf->Cell(25,5,'Orden',1,0,'C',true); 
...
$pdf->Cell(25,5,$resultado['IDORDEN'],0,0,'C'); 
...
$pdf->Output('ReporteOrdeCompraProveedor.pdf', 'D');
