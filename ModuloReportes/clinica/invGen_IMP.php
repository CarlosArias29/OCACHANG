...
$this->SetTextColor('121','105','24');	
$this->Text(80,55,'Inventario General',1,'C', 0); 
...
$consulta = mysql_query("SELECT * from inventario where FECHAINGRESOINVENTARIO BETWEEN '$fecha1' AND '$fecha2'");
