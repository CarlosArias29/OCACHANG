...
$this->SetTextColor('121','105','24');	
$this->Text(80,55,'Inventario por Producto:',1,'C', 0); 
...
$consulta = mysql_query("SELECT * from inventario where IDPRODUCTO = '$param1' and FECHAINGRESOINVENTARIO BETWEEN '$fecha1' AND '$fecha2'");
