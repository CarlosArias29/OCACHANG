...
$this->SetTextColor('121','105','24');	
$this->Text(80,55,'Salidas de Inventario:',1,'C', 0); 
...
SELECT * FROM INVENTARIO WHERE IDTRANSACCION LIKE 'SP%' AND  FECHAINGRESOINVENTARIO BETWEEN '$fecha1' AND '$fecha2'");
