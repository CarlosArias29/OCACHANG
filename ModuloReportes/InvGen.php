...
<body>
  ...
  <div>  
    ...
    <h2 id="menu">Reporte de General del Inventario</h2>   
  ...
  <form id="insertarOrden" name="insertarOrden" method="post" action="crearOrden.php">
    ...
    <p>
      ...
      <input type="submit" value="Vista Previa" onclick="this.form.action='clinica/invGen.php'">
      <input type="submit" value="Imprimir" onclick="this.form.action='clinica/invGen_IMP.php'">
