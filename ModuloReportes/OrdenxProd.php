...
<body>
  ...
  <div>  
    ...
    <h2 id="menu">Reporte de Ordenes de Compra por Producto</h2>   
...
<fieldset class='log' style='margin-bottom:20px;'>
            ...
            <div id = "div_fechaIni">
               <p>
                 <label class='log'>Seleccione el producto<br>
                   <br>
...
?>
           ...
           <div id = "div_botonesFin2">
             ...
             <p>
                <input type="submit" value="Vista Previa" onclick="this.form.action='clinica/reporte_oc_producto.php'">
              </p>
              <p>
                <input type="submit" value="Descargar" onclick="this.form.action='clinica/reporte_oc_producto - IMP.php'">
              </p>
              <p>
