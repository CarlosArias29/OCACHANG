...
<body>
  ...
  <div>  
    ...
    <h2 id="menu">Reporte de Ordenes de Compra por Proveedor</h2>   
...
<fieldset class='log' style='margin-bottom:20px;'>
      ...
      <div id = "div_datosOrdenes2"></div> 
          <!--  div_datosOrdenes --><!--  div_tabla --> Seleccione el proveedor
          <p>
        <select name="combo1" id="combo1">
                 <?php
	     include ('clinica/conexion.php');
    	$con = new DB;
      ...
      {
      $valor=$renglon['0'];
      echo "<option value=".$valor.">".$renglon[2]."</option>\n";
      }
...
?>
          ...
          <p><span class="log" style="margin-bottom:20px;">Seleccione la fecha</span></p>
             <p>
      	...
      	<input type="submit" value="Vista Previa" onclick="this.form.action='clinica/reporte_oc_PROV.php'">
      <input type="submit" value="Descargar" onclick="this.form.action='clinica/reporte_oc_PROV - IMP.php'">
      <input name="botones" type="submit" id="atras"  value="Salir" onclick="MM_goToURL('parent','../menu.php');return document.MM_returnValue"/>
    </div>
 

     <div id = "div_btnConfirmar"></div>      
