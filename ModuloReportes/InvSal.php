...
<body>
  ...
  <div>  
    ...
    <h2 id="menu">Reporte de Salidas del Inventario</h2>   
  ...
  <form id="insertarOrden" name="insertarOrden" method="post" action="crearOrden.php">
      ...
      <div id = "div_entrada" >
          ...
          <fieldset class='log' style='margin-bottom:20px;'>
            <div id = "div_fechaIni">
              <p>
                <label class='log'> Seleccione la fecha<br>
                  <br>
                  Desde: </label>
           ...
           <div id = "div_botonesFin2">
              ...
              <input type="submit" value="Vista Previa" onclick="this.form.action='clinica/invSalidas.php'">
              <input type="submit" value="Imprimir" onclick="this.form.action='clinica/invSalidas-IMP.php'">
            </div>
