...
<body>
  ...
  <div>  
    ...
    <h2 id="menu">Reporte de Existencias en Inventario</h2>   
...
?>
        ...
        <div id = "div_botonesFin2">
            <div id = "div_btnCancelar"></div>          
          <p>
          
      
  <input type="submit" value="Vista Previa" onclick="this.form.action='clinica/invXprod.php'">    
      
            <input type="submit" value="Imprimir" onClick="this.form.action='clinica/invXprod -IMP.php'">
          </p>
          <p>
