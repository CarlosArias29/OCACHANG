...
<body>
  ...
  <div>  
    ...
    <h2 id="menu">Reporte de Ordenes de Compra General</h2>   
 ...
 <p>
   <input type="submit" value="Vista previa" onClick="this.form.action='clinica/reporte_historial_general.php'">
   <input type="submit" value="Imprimir" onClick="this.form.action='clinica/reporte_historial_general - IMP.php'">
