...
<div>  
 <div id="user_activo" >
	  ...
	  <h2 id="menu">Registro de Entradas en Inventario</h2>   
      ...
      <div id = "div_entrada" >
          <div id = "div_datos">
            ...
            <label class="log">Código: &nbsp; <?php 
                                        ...
                                        //$query="SELECT IDTRANSACCION FROM INVENTARIO ORDER BY CORRELATIVO DESC;"; 
                                       ...
                                       // for($i = 0; $i < $tamaño; $i++){
                                        //  $idcompleto .= "0";
                                       // }
                                       // $idcompleto .= $nParteNumerica;
$idcompleto=Nidtransaccion();
                                       echo "<b>".$idcompleto."</b>"; 
									  
                                    ?> 
                                    <!-- <td width="416" class="log"><input type="text" name="idtransaccion" textalign="center" id="idtransaccion" value="<?php echo Nidtransaccion(); ?>" align="center" placeholder="# idtransaccion /> -->
            ...
            <div id = "div_ordenes">
              ...
              <select id="combobox" name="combobox" class = "listado" onChange="comprobarOption()" >
...
?>
     ...
     <!-- <td width="416" class="log"><input type="text" name="idtransaccion" textalign="center" id="idtransaccion" value="?>" align="center" placeholder="# idtransaccion /> -->
...
<div id = "div_datosOrdenes"  style="width: 110%; margin-left: -30px;">
...
?>
            ...
            <div id = "div_numLotes">
               <input class = "eOrdenes" type="number" name="cantidadlotes" id="cantidadlotes"  
              min="1" title = "Debe ser un número mayor que cero" placeholder="Cantidad de lotes"/>
            </div>
            <div id = "div_prodPorLote">
               <input class = "eOrdenes" type="number" name="cantidadproductosporlote" id="" min="1" title = "Debe ser un número mayor que cero"  placeholder="Numero de productos/lote"/>
            
            
            
            </div>
            <div id = "div_precioPorLote">
              <input class = "eOrdenes" type="text" name="preciolote" id="preciolote" pattern="[0-9]+([\.|,][0-9]+)?" step="0.01" title="Solo se permiten dos decimales" placeholder="Precio del lote"/>
            </div>
...
?>
          ...
          <div id = "div_tabla" style="margin-top:20px;">
            <table style="width:100%;border: 1px solid white;" width="943" border="1">
            
 <tr>

<th width="75" style="border: 1px solid white; padding: 5px;" class="log">ID del Producto</th>
<th width="150" style="border: 1px solid white; padding: 5px;" class="log">Nombre</th> 
<th width="50" style="border: 1px solid white; padding: 5px;" class="log">Cantidad de Lotes</th>
<th width="70" style="border: 1px solid white; padding: 5px;" class="log">Precio del Lote</th> 
<th width="50" style="border: 1px solid white; padding: 5px;" class="log">Cantidad de Productos por Lote</th> 
<th width="50" style="border: 1px solid white; padding: 5px;" class="log">Costo unitario del producto</th> 
...
echo "
<tr>
<td align='center' style='border: 1px solid white; padding: 5px;' class='log'>".$_SESSION['datos'][$i][0]."</td>
<td align='center' style='border: 1px solid white; padding: 5px;' class='log'>".$_SESSION['datos'][$i][1]."</td>
<td align='center' style='border: 1px solid white; padding: 5px;' class='log'>".$_SESSION['datos'][$i][2]."</td>
<td align='center' style='border: 1px solid white; padding: 5px;' class='log'>".$_SESSION['datos'][$i][3]."</td>
<td align='center' style='border: 1px solid white; padding: 5px;' class='log'>".$_SESSION['datos'][$i][4]."</td>
<td align='center' style='border: 1px solid white; padding: 5px;' class='log'>".$_SESSION['datos'][$i][5]."</td>
