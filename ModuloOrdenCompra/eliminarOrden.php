...
<body>
  ...
  <div id="dialog-message" title="Dada de Baja con éxito" style="display:none;">
  <p>
    <span class="ui-icon ui-icon-circle-check" style="float: left; margin: 0 7px 50px 0;"></span>
    <p>Orden de compra dada de baja con éxito.</p>
</div>
  <!-- Confirmacion de guardado-->
  ...
  <div>  
    <div id="user_activo" >
	  ...
	  <h2 id="menu">Dar de Baja Orden de Compra</h2>   

  <form id="insertarOrden" name="insertarOrden" method="post" action="eliminarOrden.php">
      ...
      <div id = "div_entrada" >
                ...
                <?php 
                  ...
                  switch( $_POST['botones'] ) {
                    ...
                    case "Confirmar":{ 
                      ...
                      //recuperamos los datos a dar de baja
                      for($i=0;$i<$_SESSION['contador'];$i++) {
                        ...
                        //echo $SQL = "UPDATE ORDENDECOMPRA SET CANTIDADLOTES =".$cantidad.", COSTOPORLOTE =".$precxlote.", PRODUCTOSXLOTE =".$prodxlote.",COSTOUNITARIO =".($precxlote/$prodxlote)." WHERE IDORDEN = '".$_SESSION['idSeleccionado']."';";
                        //mysql_query ($SQL);

                        
                        if (isset($_REQUEST['check'])){
                           $SQL = "UPDATE ORDENDECOMPRA SET ESTADO = 3 WHERE IDORDEN = '".$_SESSION['idSeleccionado']."';";
                           mysql_query ($SQL);
                        ...
                        if ($_POST['botones']=="Confirmar" && isset($_REQUEST['check']) && $_SESSION['contador']>0){ 
                        ?> 
                            <script languaje="javascript"> 
                                confirmacion(); 
                            </script> 
          ...
          <div id = "div_tabla" style="margin-top:20px;">
            <table class = "tablaDin" style="border: 1px solid white;">
              <tr>
                <th colspan="5" style="color: white;">Orden N°:&nbsp; <?php echo $_SESSION['idSeleccionado']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¿Dar de Baja? <input name = 'check' type = 'checkbox' style = 'margin-left:20px; -moz-transform: scale(2); -webkit-transform: scale(2); /* Safari and Chrome */'></th> 
              </tr>
              <tr>
                <th>Productos</th>
                ...
                for($i=0;$i<$_SESSION['contador'];$i++) {
                  echo "
                    <tr>
                      ...
                      <td> <input name='canLotes".$i."' type=\"number\"  min=\"1\" title = \"Debe ser un número mayor que cero\" value=\"".$_SESSION['datos'][$i][1]."\"/ readonly> </td>
                      <td> <input name='pLotes".$i."' type=\"number\"  min=\"1\" title = \"Debe ser un número mayor que cero\" value=\"".$_SESSION['datos'][$i][2]."\"/ readonly> </td>  
                      <td> <input name='precLote".$i."' type=\"number\" pattern=\"[0-9]+([\.|,][0-9]+)?\" step=\"0.01\" title=\"Solo se permiten dos decimales\" value=\"".$_SESSION['datos'][$i][3]."\"/ readonly> </td>
